...
class AdressBookTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            // remove the delete item from the dataSource
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if (segue.identifier == "ContactDetailsSegue"){
            ...
            let destination = segue.destination as! ContactsDetailsTableViewController
    ...
    @IBAction func save(SaveSegue segue: UIStoryboardSegue) {
        ...
        // 3. refresh the table view to update the list
